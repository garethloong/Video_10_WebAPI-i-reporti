...
{
  [Autorizacija(false, KorisnickaUloga.SuperAdministrator, KorisnickaUloga.AdministratorInstitucije, KorisnickaUloga.StudentskaSluzba)]
    public class StudiranjeController : Controller
    {
        ...
        public ActionResult Index(int? fakultetId)
        {
            ...
            if (!studentskeSlube.Any())
                return new HttpStatusCodeResult(404, "Nemate permisije");
